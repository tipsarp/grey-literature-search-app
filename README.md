...
- This app was designed around the idea of using it to document Grey Literature Searches for a Scoping Review that I am leading
...
- I used this opportunity to improve the UX/UI of the documentation form, brush up on `Shiny`, AND learn `SQL`
